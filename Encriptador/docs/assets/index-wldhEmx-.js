...
const Navbar$3 = "_Navbar_1ws3b_1";
const pageArticulo = "_pageArticulo_1ws3b_9";
const style$7 = {
  Navbar: Navbar$3,
  pageArticulo
};
const ADD_ART = "ADD_ART";
const ADD_ARTLike = "ADD_ARTLike";
...
const add_art = (input) => {
  return async (dispatch) => {
    const { cantidad: cantidad2, codBarras, page } = input;
    if (codBarras.trim().length === 0) {
      const { data } = await axios$1.get(`http://localhost:3001/tienda/articulo`);
      return dispatch({
        type: "GET_ALL",
        payload: data
      });
    ...
    try {
      const { data } = await axios$1.get(`http://localhost:3001/tienda/articulo/${codBarras}`);
      dispatch({
        type: ADD_ART,
        payload: {
          cantidad: cantidad2,
      ...
      try {
        const { data } = await axios$1.get(`http://localhost:3001/tienda/articuloLike/${codBarras}`);
        dispatch({
          type: ADD_ARTLike,
          payload: { data }
        });
...
const get_list = (input) => {
  return {
    type: "GET_LIST",
    payload: input
  };
};
const remove_art = (input) => {
  return {
    type: REMOVE_ART,
    payload: input
  };
};
const modificar_cant = (input) => {
  return {
    type: "MODIFICAR_CANT",
    payload: input
  };
};
const add_vendedor = (input) => {
  return {
    type: "ADD_VENDEDOR",
    payload: input
  };
};
const add_cotizacion = (input) => {
  return {
    type: "ADD_COTIZACION",
    payload: input
  };
};
const order_articulos = (order) => {
  return {
    type: "ORDER",
    payload: order
  };
};
const container = "_container_1jx0l_1";
const close = "_close_1jx0l_7";
const style$6 = {
  container,
  close
};
function PageArticulo(props) {
  const { id: id2, onClose } = props;
  useSelector((state) => state.producto);
  const dispatch = useDispatch();
  const handleClick = () => {
    dispatch(get_list(id2));
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style$6.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `/ventana/${id2}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "btn btn-outline-primary", onClick: handleClick, children: [
      "Nuevo ",
      id2
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: `${"btn-close "}${style$6.close}`, onClick: () => {
      onClose(id2);
    }, "aria-label": "Close" })
  ] }) });
}
function Navbar$2() {
  const [id_, setID] = reactExports.useState(0);
  const [button, setButton] = reactExports.useState([]);
  const handleClick = () => {
    setButton([...button, { id: id_ }]);
    setID(id_ + 1);
  };
  const onClose = (idFilter) => {
    const newButtons = button.filter((b2) => b2.id !== idFilter);
    setButton(newButtons);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style$7.Navbar, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "navbar ", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "btn-group", role: "group", "aria-label": "Basic outlined example", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-sm btn-outline-secondary", children: "Ventas" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-sm btn-outline-secondary", children: "Caja" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-sm btn-outline-secondary", children: "Clientes" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-sm btn-outline-secondary", children: "Provedores" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-sm btn-outline-secondary", children: "Estadisticas" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-sm btn-outline-secondary", children: "Reportes" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/provedor", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-sm btn-outline-secondary", children: "Articulos" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-sm btn-outline-secondary", children: "Operaciones" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-sm btn-outline-secondary", children: "Administracón" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "navbar", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "btn-group", role: "group", "aria-label": "Basic outlined example", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-outline-primary", children: "Caja" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-outline-primary", onClick: handleClick, children: "Nuevo" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/altaArticulo", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-outline-primary", children: "Alta de articulo" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/ventana", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-outline-primary", children: "Comprobantes" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/listaArticulos", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-outline-primary", children: "Lista de articulos" }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: style$7.pageArticulo, children: button.map((prod, id2) => /* @__PURE__ */ jsxRuntimeExports.jsx(PageArticulo, { id: prod.id, onClose }, id2)) })
  ] });
}
const AltaArticulo$1 = "_AltaArticulo_1twvq_1";
const stock = "_stock_1twvq_9";
const Provedor = "_Provedor_1twvq_33";
const costo = "_costo_1twvq_41";
const nombre = "_nombre_1twvq_65";
const containerNombreStock = "_containerNombreStock_1twvq_71";
const botones = "_botones_1twvq_79";
const precioVenta = "_precioVenta_1twvq_89";
const style$5 = {
  AltaArticulo: AltaArticulo$1,
  stock,
  Provedor,
  costo,
  nombre,
  containerNombreStock,
  botones,
  precioVenta
};
function AltaArticulo(props) {
  ...
  reactExports.useEffect(() => {
    axios$1(`http://localhost:3001/tienda/articulo/${id2}`).then(({ data }) => {
      if (data.name) {
        console.log(data);
        setForm(data);
      }
  ...
  const actualizarDato = () => {
    ...
    axios$1.post("http://localhost:3001/tienda/actualizararticulo", body).then((res) => {
      console.log(res);
    }).catch((error) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style$5.AltaArticulo, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Alta Articulos" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style$5.containerNombreStock, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style$5.nombre, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-text", children: "Nombre :" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", className: "form-control", "aria-label": "Dollar amount (with dot and two decimal places)", name: "name", value: form.name, onChange: handleChange })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-text", children: "Codigo de barras (o codigo de articulo):" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", className: "form-control", "aria-label": "Dollar amount (with dot and two decimal places)", name: "id", value: form.id, onChange: handleChange })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-text", children: "Categoria" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "form-select", "aria-label": "Default select example", defaultValue: "default", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "default", children: "sin categoria" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-text", children: "Fabricante" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "form-select", "aria-label": "Default select example", defaultValue: "default", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "default", children: "sin fabricante" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1", children: "One" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "2", children: "Two" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "3", children: "Three" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style$5.costo, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-text", children: "Costo Peso: AR$" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", className: "form-control", "aria-label": "Dollar amount (with dot and two decimal places)", name: "costoPeso", value: form.costoPeso, onChange: handleChange })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-text", children: "Costo Dolar: US$" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", className: "form-control", "aria-label": "Dollar amount (with dot and two decimal places)", name: "costoDolar", value: form.costoDolar, onChange: handleChange })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-text", children: "Iva %:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", className: "form-control", "aria-label": "Dollar amount (with dot and two decimal places)", name: "iva", value: form.iva, onChange: handleChange })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-text", children: "Ganancias %:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", className: "form-control", "aria-label": "Dollar amount (with dot and two decimal places)", name: "ganancia", value: form.ganancia, onChange: handleChange })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-text", children: "precio Venta :$" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "form-control", "aria-label": "Dollar amount (with dot and two decimal places)", name: "precioVenta", value: form.precioVenta, onChange: handleChange })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style$5.stock, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-text", children: "Stock:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", className: "form-control", "aria-label": "Dollar amount (with dot and two decimal places)", name: "stock", value: form.stock, onChange: handleChange })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-text", children: "Stock minimo:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", className: "form-control", "aria-label": "Dollar amount (with dot and two decimal places)", name: "stockMin", value: form.stockMin, onChange: handleChange })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-check", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "form-check-input", type: "checkbox", value: "", id: "flexCheckDefault" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-check-label", htmlFor: "flexCheckDefault", children: "por unidad" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-check", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "form-check-input", type: "checkbox", value: "", id: "flexCheckChecked" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-check-label", htmlFor: "flexCheckChecked", children: "por peso" })
          ] })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "exampleFormControlTextarea1", className: "form-label", children: "Descripción:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { className: "form-control", id: "exampleFormControlTextarea1", resize: "false", rows: "3", name: "descripcion", value: form.descripcion, onChange: handleChange })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style$5.botones, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-danger", onClick: actualizarDato, children: "Actualizar" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-danger", onClick: handleClick, children: "Nuevo" })
    ] })
  ] });
}
const Home = "_Home_1844g_1";
const registrarCompra = "_registrarCompra_1844g_13";
const addArticulo = "_addArticulo_1844g_25";
const ListArticulo = "_ListArticulo_1844g_39";
const cliente = "_cliente_1844g_59";
const Costo$1 = "_Costo_1844g_73";
const condicion = "_condicion_1844g_93";
const info = "_info_1844g_117";
const style$4 = {
  Home,
  registrarCompra,
  addArticulo,
...
const busqueda = "_busqueda_4fv86_1";
const style$3 = {
  busqueda
};
function Articulo$1(props) {
  useSelector((state) => state.producto);
  const dispatch = useDispatch();
  const { id: id2 } = useParams();
  const [id_, setId] = reactExports.useState(1);
  const [Articulo2, setArticulo] = reactExports.useState({
    id: 0,
    codBarras: "",
    cantidad: 1,
    page: 0
  ...
  const addHandler = () => {
    const { cantidad: cantidad2, codBarras, page } = Articulo2;
    dispatch(add_art({
      cantidad: cantidad2,
      codBarras,
      page
  ...
  const handleChangue = (event) => {
    const property = event.target.name;
    const value = event.target.value;
    setArticulo({ ...Articulo2, [property]: value });
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${"input-group mb-3"} `, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: `${"form-select"} ${style$3.busqueda}`, "aria-label": "Default select example", defaultValue: "default", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "default", children: "Cod Barras" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1", children: "Nombre" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", className: " form-control", "aria-label": "Dollar amount (with dot and two decimal places)", name: "codBarras", onChange: handleChangue, onKeyDown: handleKeyDown, value: Articulo2.codBarras })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${"input-group mb-3"} `, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", { className: `${"form-select"} ${style$3.busqueda}`, "aria-label": "Default select example", defaultValue: "default", children: /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "default", children: "Unidades" }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { onClick: (event) => {
        event.target.value = "";
      }, id: "cantidad", type: "text", className: "form-control", "aria-label": "Dollar amount (with dot and two decimal places)", name: "cantidad", onChange: handleChangue, onKeyDown: handleKeyDown, value: Articulo2.cantidad }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-success", onClick: addHandler, children: "➕ Cantidad" })
    ] })
  ] });
}
const listArticulo = "_listArticulo_6c1wf_1";
const nomFilas = "_nomFilas_6c1wf_11";
const style$2 = {
  listArticulo,
  nomFilas
};
const cantidad = "_cantidad_rsfag_1";
const containerProducto = "_containerProducto_rsfag_9";
const style$1 = {
  cantidad,
  containerProducto
};
function Articulo(props) {
  ...
  const { data, id: id2 } = props;
  const { cantidad: cantidad2, producto } = data;
  const dispatch = useDispatch();
  const handleClick = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "row", children: id2 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: style$1.containerProducto, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `/detail/${producto.id}`, children: producto.id }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: style$1.containerProducto, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `/detail/${producto.id}`, children: producto.name }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { id: "cantidadArticulo", className: style$1.cantidad, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: cantidad2 }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-success", onClick: handleClick, children: "+" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-danger", onClick: handleClickMenos, children: "-" })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
      "$ ",
      producto.precioVenta * cantidad2
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-danger", onClick: onClose, children: "🗑" }) })
  ] });
}
function ListaArticulos$2(props) {
  const { producto } = props;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: producto.map(
    (prod, id2) => {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Articulo, { id: id2, data: prod }, id2);
    }
  ) });
}
function ListaArticulos$1(props) {
  const { productos } = props;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: style$2.listArticulo, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "table", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "#" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Código de barras" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Nombre" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Cantidad" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Precio" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Subtotal" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "-" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ListaArticulos$2, { producto: productos }) })
  ] }) });
}
function Navbar$1() {
  reactExports.useState("collapse");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group mb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-text", children: "DNI/CUIT" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", className: "form-control", "aria-label": "Dollar amount (with dot and two decimal places)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-info", children: "Info" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-danger", children: "Danger" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group mb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-text", children: "Nombre" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", className: "form-control", "aria-label": "Dollar amount (with dot and two decimal places)" }),
...
function Costo() {
  ...
  const [costo2, setCosto] = reactExports.useState(
    {
      subTotal: "0.00"
    }
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: style$4.Costo, children: /* @__PURE__ */ jsxRuntimeExports.jsx("table", { className: "table table-success table-striped", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "row", children: "Subtotal:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: costo2.subTotal })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "row", children: "Descuento:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "form-select form-select-sm", "aria-label": "Small select example", defaultValue: "1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1", children: "Sin descuento" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "2", children: "Two" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "3", children: "Three" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", {})
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "row", children: "Total" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { id: "costoTotal", colSpan: "2", children: costo2.subTotal })
    ] })
  ] }) }) });
}
function Condicion() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style$4.condicion, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "exampleFormControlTextarea1", className: "form-label", children: "Observaciones" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { className: "form-control", id: "exampleFormControlTextarea1", rows: "4", cols: "30" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "form-select form-select-sm", "aria-label": "Small select example", defaultValue: vendedor, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "A", children: "Administrador" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1", children: "Vendedor 1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "2", children: "Vendedor 2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "3", children: "Vendedor 3" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "form-select form-select-sm", "aria-label": "Small select example", defaultValue: "1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1", children: "Lista de Precios 1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1", children: "Lista de Precios 2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1", children: "Lista de Precios 3" })
      ] })
    ] })
  ] });
}
function ArticuloEncontrados(props) {
  const { productos } = props;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: productos.id }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `/detail/${productos.id}`, children: productos.name }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
      "$",
      productos.precioVenta,
      pathname !== "/listaArticulos" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-success", onClick: handleClick, children: "Agregar" })
    ] })
  ] });
}
function ListaArticulosEncontrados(props) {
  const { productos } = props;
  const dispatch = useDispatch();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: style$2.listArticulo, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "table", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: style$2.nomFilas, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("th", { scope: "col", children: [
        "Código de barras  ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: productos.map(
      (prod, index2) => {
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ArticuloEncontrados, { productos: prod, onClose: props.onClose }, index2);
      }
    ) })
  ] }) });
}
function Navbar() {
  reactExports.useState("collapse");
  const fecha = (/* @__PURE__ */ new Date()).toString();
  ...
  const [productoProp, setProductoProp] = reactExports.useState([]);
  const [productoLikeProp, setproductoLikeProp] = reactExports.useState([]);
  const { id: id2 } = useParams();
  reactExports.useEffect(() => {
    if (listProductos[id2]) {
  ...
  }, [id2, productos, listProductos, productoLike]);
  const generarRecibo = () => {
    console.log({
      productos,
      fecha,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style$4.Home, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-text", children: fecha }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style$4.registrarCompra, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style$4.addArticulo, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Ingrese un articulo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Articulo$1, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style$4.cliente, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Cliente" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar$1, {})
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ListaArticulosEncontrados, { productos: productoLikeProp })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style$4.ListArticulo, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ListaArticulos$1, { productos: productoProp }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style$4.info, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Condicion, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Costo, {})
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn btn-success", onClick: generarRecibo, children: "Generar recibo" })
      ] })
    ] }),
...
function Detail() {
  const [infoArticulo, setInfoArticulo] = reactExports.useState({});
  const { id: id2 } = useParams();
  useNavigate();
  reactExports.useEffect(() => {
    axios$1(`http://localhost:3001/tienda/articulo/${id2}`).then(({ data }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AltaArticulo, { infoArticulo }) });
}
function ListaArticulos(props) {
  const [allProductos, setAllProductos] = reactExports.useState([]);
  reactExports.useEffect(() => {
    axios$1(`http://localhost:3001/tienda/articulo`).then(({ data }) => {
      setAllProductos(data);
    });
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ListaArticulosEncontrados, { productos: allProductos }) });
}
const login = "_login_21vmz_1";
const style = {
  login
};
function Login(props) {
  ...
  const [Cotizacion, setCotizacion] = reactExports.useState({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: style.login, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { id: "vendedor", className: "form-select form-select-sm", "aria-label": "Small select example", defaultValue: Vendedor, name: "vendedor", onChange: handleChange, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "A", children: "Administrador" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1", children: "Vendedor 1" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "2", children: "Vendedor 2" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "3", children: "Vendedor 3" })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "password", children: "Cotizacion dolar MEP : " }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { name: "mep", value: Cotizacion.mep, onChange: handleChange })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "password", children: "Cotizacion dolar BLUE : " }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { name: "blue", value: Cotizacion.blue, onChange: handleChange })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", onClick: submitHandler, children: " Confirmar " }) })
  ] }) });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "App", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/ventana/:id", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/listaArticulos", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ListaArticulos, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/altaArticulo", element: /* @__PURE__ */ jsxRuntimeExports.jsx(AltaArticulo, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/ventana", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Ventana, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/provedor", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Ventana, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/categoria", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Ventana, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/fabricante", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Ventana, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/detail/:id", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Detail, {}) })
    ] })
  ] });
}
function _typeof(o) {
...
const rootReducer = (state = initialState, { type, payload }) => {
  switch (type) {
    case ADD_ART:
      const { page, cantidad: cantidad2, producto } = payload;
      const newProductos = [...state.listProductos];
      newProductos[page] = [...newProductos[page], { page, cantidad: cantidad2, producto }];
    ...
    case "MODIFICAR_CANT":
      const newLista1 = state.producto.map((prod, index2) => {
        if (index2 === payload.id) {
          const { page: page2, producto: producto2, cantidad: cantidad3 } = prod;
          return {
            page: page2,
            producto: producto2,
            cantidad: Number(cantidad3) + payload.cant
          };
        }
        return prod;
      });
    ...
    case REMOVE_ART:
      const newLista = state.producto.filter((prod, index2) => index2 !== payload.id);
    ...
    case "ORDER":
      ...
      if (payload === "A") {
        orderedCharacters = [...state.productoLike].sort((a, b2) => a.id.toString().localeCompare(b2.id.toString()));
      } else {
        orderedCharacters = [...state.productoLike].sort((a, b2) => b2.id.toString().localeCompare(a.id.toString()));
      }
      return {
        ...state,
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(Provider, { store, children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) })
);
